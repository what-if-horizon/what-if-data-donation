...
X_ENTRIES: dict[str, list[Entry]] = {
    ...
    'Account-Suspension': [
        Entry(table='Account-Suspension', filename='data/account-suspension.js', static_fields={}, list_blocks={}),
    ],
    'Ad-Engagements': [
        Entry(table='Ad-Engagements', filename='data/ad-engagements.js', static_fields={}, list_blocks={('ad', 'adsUserData', 'adEngagements', 'engagements'): {'displayLocation': ('impressionAttributes', 'displayLocation'), 'impressionTime': ('impressionAttributes', 'impressionTime'), 'tweetId': ('impressionAttributes', 'promotedTweetInfo', 'tweetId'), 'tweetText': ('impressionAttributes', 'promotedTweetInfo', 'tweetText'), 'urls': ('impressionAttributes', 'promotedTweetInfo', 'urls'), 'mediaUrls': ('impressionAttributes', 'promotedTweetInfo', 'mediaUrls'), 'advertiserName': ('impressionAttributes', 'advertiserInfo', 'advertiserName'), 'screenName': ('impressionAttributes', 'publisherInfo', 'screenName'), 'trendId': ('impressionAttributes', 'promotedTrendInfo', 'trendId'), 'name': ('impressionAttributes', 'promotedTrendInfo', 'name'), 'description': ('impressionAttributes', 'promotedTrendInfo', 'description'), 'publisherName': ('impressionAttributes', 'publisherInfo', 'publisherName')}, ('ad', 'adsUserData', 'adEngagements', 'engagements', 'engagementAttributes'): {'engagementTime': ('engagementTime',), 'engagementType': ('engagementType',)}, ('ad', 'adsUserData', 'adEngagements', 'engagements', 'impressionAttributes', 'matchedTargetingCriteria'): {'targetingType': ('targetingType',), 'targetingValue': ('targetingValue',)}}),
    ],
    'Ad-Impressions': [
        Entry(table='Ad-Impressions', filename='data/ad-impressions.js', static_fields={}, list_blocks={}),
    ],
    'Ad-Mobile-Conversions-Attributed': [
        Entry(table='Ad-Mobile-Conversions-Attributed', filename='data/ad-mobile-conversions-attributed.js', static_fields={}, list_blocks={}),
    ],
    'Ad-Mobile-Conversions-Unattributed': [
        Entry(table='Ad-Mobile-Conversions-Unattributed', filename='data/ad-mobile-conversions-unattributed.js', static_fields={}, list_blocks={}),
    ],
    'Ad-Online-Conversions-Attributed': [
        Entry(table='Ad-Online-Conversions-Attributed', filename='data/ad-online-conversions-attributed.js', static_fields={}, list_blocks={}),
    ],
    'Ad-Online-Conversions-Unattributed': [
        Entry(table='Ad-Online-Conversions-Unattributed', filename='data/ad-online-conversions-unattributed.js', static_fields={}, list_blocks={}),
    ],
    'Article': [
        Entry(table='Article', filename='data/article.js', static_fields={}, list_blocks={}),
    ],
    'Article-Metadata': [
        Entry(table='Article-Metadata', filename='data/article-metadata.js', static_fields={}, list_blocks={}),
    ],
    'Block': [
        Entry(table='Block', filename='data/block.js', static_fields={}, list_blocks={}),
    ],
    'Community-Note': [
        Entry(table='Community-Note', filename='data/community-note.js', static_fields={}, list_blocks={}),
    ],
    'Community-Note-Batsignal': [
        Entry(table='Community-Note-Batsignal', filename='data/community-note-batsignal.js', static_fields={}, list_blocks={}),
    ],
    'Community-Note-Rating': [
        Entry(table='Community-Note-Rating', filename='data/community-note-rating.js', static_fields={'noteId': ('communityNoteRating', 'noteId'), 'helpfulnessLevel': ('communityNoteRating', 'helpfulnessLevel'), 'createdAt': ('communityNoteRating', 'createdAt'), 'userId': ('communityNoteRating', 'userId'), 'helpfulTags': ('communityNoteRating', 'helpfulTags')}, list_blocks={}),
    ],
    'Community-Note-Tombstone': [
        Entry(table='Community-Note-Tombstone', filename='data/community-note-tombstone.js', static_fields={}, list_blocks={}),
    ],
    'Community-Tweet': [
        Entry(table='Community-Tweet', filename='data/community-tweet.js', static_fields={}, list_blocks={}),
    ],
    'Follower': [
    ...
    'Grok-Chat-Item': [
        Entry(table='Grok-Chat-Item', filename='data/grok-chat-item.js', static_fields={}, list_blocks={}),
    ],
    'Like': [
    ...
    'Lists-Created': [
        Entry(table='Lists-Created', filename='data/lists-created.js', static_fields={'url': ('userListInfo', 'url')}, list_blocks={}),
    ],
    'Lists-Member': [
        Entry(table='Lists-Member', filename='data/lists-member.js', static_fields={'url': ('userListInfo', 'url')}, list_blocks={}),
    ],
    'Lists-Subscribed': [
        Entry(table='Lists-Subscribed', filename='data/lists-subscribed.js', static_fields={'url': ('userListInfo', 'url')}, list_blocks={}),
    ],
    'Manifest': [
        Entry(table='Manifest', filename='data/manifest.js', static_fields={'generationDate': ('archiveInfo', 'generationDate')}, list_blocks={}),
    ],
    'Moment': [
        Entry(table='Moment', filename='data/moment.js', static_fields={}, list_blocks={}),
    ],
    'Mute': [
        Entry(table='Mute', filename='data/mute.js', static_fields={}, list_blocks={}),
    ],
    'Note-Tweet': [
        Entry(table='Note-Tweet', filename='data/note-tweet.js', static_fields={}, list_blocks={}),
    ],
    'Personalization': [
        Entry(table='Personalization', filename='data/personalization.js', static_fields={'shows': ('p13nData', 'interests', 'shows'), 'age': ('p13nData', 'inferredAgeInfo', 'age'), 'birthDate': ('p13nData', 'inferredAgeInfo', 'birthDate'), 'gender': ('p13nData', 'demographics', 'genderInfo', 'gender'), 'lookalikeAdvertisers': ('p13nData', 'interests', 'audienceAndAdvertisers', 'lookalikeAdvertisers'), 'advertisers': ('p13nData', 'interests', 'audienceAndAdvertisers', 'advertisers'), 'numAudiences': ('p13nData', 'interests', 'audienceAndAdvertisers', 'numAudiences')}, list_blocks={('p13nData', 'demographics', 'languages'): {'language': ('language',), 'isDisabled': ('isDisabled',)}, ('p13nData', 'interests', 'interests'): {'name': ('name',), 'isDisabled': ('isDisabled',)}}),
    ],
    'Professional-Data': [
        Entry(table='Professional-Data', filename='data/professional-data.js', static_fields={}, list_blocks={}),
    ],
    'Protected-History': [
        Entry(table='Protected-History', filename='data/protected-history.js', static_fields={}, list_blocks={}),
    ],
    'Reply-Prompt': [
        Entry(table='Reply-Prompt', filename='data/reply-prompt.js', static_fields={}, list_blocks={}),
    ],
    'Saved-Search': [
...
FB_ENTRIES: dict[str, list[Entry]] = {
    ...
    'Ads About Meta': [
        Entry(table='Ads About Meta', filename='ads_information/ads_about_meta.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',), 'timestamp_value': ('timestamp_value',)}, ('media',): {'media': ()}}),
    ],
    ...
    'Ads Interests': [
        Entry(table='Ads Interests', filename='logged_information/other_logged_information/ads_interests.json', static_fields={'topics_v2': ('topics_v2',)}, list_blocks={('topics_v2',): {'topics_v2': ()}}),
    ],
    'Ads Personalization Consent': [
        Entry(table='Ads Personalization Consent', filename='ads_information/ads_personalization_consent.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'timestamp_value': ('timestamp_value',), 'ent_field_name': ('ent_field_name',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Ads Viewed': [
        Entry(table='Ads Viewed', filename='ads_information/ads_and_topics/ads_viewed.json', static_fields={}, list_blocks={('impressions_history_ads_seen',): {'value': ('string_map_data', 'Author', 'value'), 'timestamp': ('string_map_data', 'Time', 'timestamp')}}),
    ],
    'Advertisers Using Your Activity Or Information': [
        Entry(table='Advertisers Using Your Activity Or Information', filename='ads_information/advertisers_using_your_activity_or_information.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'ent_field_name': ('ent_field_name',)}, ('label_values', 'vec'): {'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    ...
    "Advertisers You'Ve Interacted With": [
        Entry(table="Advertisers You'Ve Interacted With", filename="ads_information/advertisers_you've_interacted_with.json", static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={('history_v2',): {'title': ('title',), 'action': ('action',), 'timestamp': ('timestamp',)}, (): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',)}}),
    ],
    'Archived Stories': [
    ...
    'Consents': [
        Entry(table='Consents', filename='logged_information/other_logged_information/consents.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'ent_field_name': ('ent_field_name',), 'timestamp_value': ('timestamp_value',)}, ('media',): {'media': ()}}),
    ],
    'Content Sharing Links You Have Created': [
        Entry(table='Content Sharing Links You Have Created', filename='personal_information/profile_information/your_facebook_activity/posts/content_sharing_links_you_have_created.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',), 'href': ('href',)}}),
        Entry(table='Content Sharing Links You Have Created', filename='your_facebook_activity/posts/content_sharing_links_you_have_created.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, ('label_values',): {'label': ('label',), 'value': ('value',), 'href': ('href',), 'ent_field_name': ('ent_field_name',)}, ('media',): {'media': ()}}),
    ],
    'Controls': [
        ...
        Entry(table='Controls', filename='preferences/feed/controls.json', static_fields={}, list_blocks={('controls',): {'name': ('name',), 'description': ('description',), 'entries': ('entries',)}, ('controls', 'entries'): {'entries': ()}}),
    ],
    'Edits You Made To Posts': [
        Entry(table='Edits You Made To Posts', filename='personal_information/profile_information/your_facebook_activity/posts/edits_you_made_to_posts.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
        Entry(table='Edits You Made To Posts', filename='your_facebook_activity/posts/edits_you_made_to_posts.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
    ],
    'Emails We Sent You': [
        Entry(table='Emails We Sent You', filename='personal_information/other_personal_information/emails_we_sent_you.json', static_fields={'title': ('title',), 'timestamp': ('timestamp',)}, list_blocks={(): {'title': ('title',), 'timestamp': ('timestamp',)}}),
    ],
    'Facebook Reels Usage Information': [
        Entry(table='Facebook Reels Usage Information', filename='logged_information/other_logged_information/facebook_reels_usage_information.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'ent_field_name': ('ent_field_name',)}, ('label_values', 'dict'): {'label': ('label',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Feed': [
    ...
    'Followers 1': [
        Entry(table='Followers 1', filename='connections/followers_and_following/followers_1.json', static_fields={'title': ('title',), 'media_list_data': ('media_list_data',)}, list_blocks={(): {'title': ('title',), 'media_list_data': ('media_list_data',)}, ('string_list_data',): {'href': ('href',), 'value': ('value',), 'timestamp': ('timestamp',)}}),
    ],
    'Following': [
        Entry(table='Following', filename='connections/followers_and_following/following.json', static_fields={}, list_blocks={('relationships_following',): {'title': ('title',), 'media_list_data': ('media_list_data',)}, ('relationships_following', 'string_list_data'): {'href': ('href',), 'value': ('value',), 'timestamp': ('timestamp',)}}),
    ],
    'Fundraiser Posts You Likely Viewed': [
        ...
        Entry(table='Fundraiser Posts You Likely Viewed', filename='your_facebook_activity/fundraisers/fundraiser_posts_you_likely_viewed.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',)}, ('media',): {'media': ()}}),
    ],
    ...
    "Group Invites You'Ve Sent": [
        Entry(table="Group Invites You'Ve Sent", filename="your_facebook_activity/groups/group_invites_you've_sent.json", static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
    ],
    ...
    'Groups And Pages That You May Find Engaging': [
        Entry(table='Groups And Pages That You May Find Engaging', filename='your_facebook_activity/groups/groups_and_pages_that_you_may_find_engaging.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'ent_field_name': ('ent_field_name',), 'label': ('label',)}, ('label_values', 'vec'): {'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Groups You Ve Visited': [
        Entry(table='Groups You Ve Visited', filename='logged_information/your_interactions_on_facebook/groups_you_ve_visited.json', static_fields={'timestamp': ('timestamp',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, ('label_values',): {'ent_field_name': ('ent_field_name',), 'label': ('label',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    "Groups You'Ve Visited": [
        Entry(table="Groups You'Ve Visited", filename="logged_information/interactions/groups_you've_visited.json", static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
        Entry(table="Groups You'Ve Visited", filename="logged_information/your_interactions_on_facebook/groups_you've_visited.json", static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
    ],
    ...
    'Likes And Reactions': [
        Entry(table='Likes And Reactions', filename='personal_information/profile_information/your_facebook_activity/comments_and_reactions/likes_and_reactions.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
        Entry(table='Likes And Reactions', filename='your_facebook_activity/comments_and_reactions/likes_and_reactions.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, ('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',), 'href': ('href',), 'title': ('title',)}, ('label_values', 'dict'): {'title': ('title',)}, ('label_values', 'dict', 'dict'): {'ent_field_name': ('ent_field_name',), 'label': ('label',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Other Categories Used To Reach You': [
        Entry(table='Other Categories Used To Reach You', filename='ads_information/other_categories_used_to_reach_you.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',), 'bcts': ('bcts',)}, list_blocks={('label_values',): {'label': ('label',), 'ent_field_name': ('ent_field_name',)}, ('label_values', 'vec'): {'value': ('value',)}, ('media',): {'media': ()}, ('bcts',): {'bcts': ()}}),
    ],
    ...
    'People And Friends': [
        Entry(table='People And Friends', filename='logged_information/activity_messages/people_and_friends.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={('people_interactions_v2',): {'name': ('name',), 'description': ('description',)}, ('people_interactions_v2', 'entries'): {'timestamp': ('timestamp',), 'name': ('data', 'name'), 'uri': ('data', 'uri')}, (): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
    ],
    ...
    'Posts On Other Pages And Profiles': [
        Entry(table='Posts On Other Pages And Profiles', filename='personal_information/profile_information/your_facebook_activity/posts/posts_on_other_pages_and_profiles.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
    ...
    'Reduce': [
        Entry(table='Reduce', filename='preferences/feed/reduce.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'ent_field_name': ('ent_field_name',), 'label': ('label',), 'value': ('value',), 'timestamp_value': ('timestamp_value',)}, ('media',): {'media': ()}}),
    ],
    'Reels Preferences': [
        ...
        Entry(table='Reels Preferences', filename='preferences/preferences/reels_preferences.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',), 'vec': ('vec',)}, ('media',): {'media': ()}, ('label_values', 'vec'): {'vec': ()}}),
    ],
    ...
    'Video': [
        ...
        Entry(table='Video', filename='preferences/preferences/video.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('watch_videos_v2',): {'video_title': ('video_title',), 'user_action': ('user_action',), 'action_time': ('action_time',), 'feedback_collection': ('feedback_collection',)}, ('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',), 'vec': ('vec',), 'timestamp_value': ('timestamp_value',), 'title': ('title',)}, ('label_values', 'dict'): {'title': ('title',)}, ('label_values', 'dict', 'dict'): {'ent_field_name': ('ent_field_name',), 'label': ('label',), 'value': ('value',), 'href': ('href',), 'title': ('title',)}, ('label_values', 'dict', 'dict', 'dict'): {'title': ('title',)}, ('label_values', 'dict', 'dict', 'dict', 'dict'): {'ent_field_name': ('ent_field_name',), 'label': ('label',), 'value': ('value',)}, ('media',): {'media': ()}, ('label_values', 'vec'): {'vec': ()}}),
    ],
    'Videos Watched': [
        Entry(table='Videos Watched', filename='ads_information/ads_and_topics/videos_watched.json', static_fields={}, list_blocks={('impressions_history_videos_watched',): {'value': ('string_map_data', 'Author', 'value'), 'timestamp': ('string_map_data', 'Time', 'timestamp')}}),
    ],
    ...
    'Your Comment Edits': [
        Entry(table='Your Comment Edits', filename='personal_information/profile_information/your_facebook_activity/comments_and_reactions/your_comment_edits.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
        Entry(table='Your Comment Edits', filename='your_facebook_activity/comments_and_reactions/your_comment_edits.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'value': ('value',)}}),
    ],
    ...
    'Your Pages Mentions': [
        Entry(table='Your Pages Mentions', filename='ads_information/your_pages_mentions.json', static_fields={'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, list_blocks={(): {'timestamp': ('timestamp',), 'media': ('media',), 'fbid': ('fbid',)}, ('label_values',): {'label': ('label',), 'vec': ('vec',)}}),
    ],
    'Your Post Audiences': [
        Entry(table='Your Post Audiences', filename='connections/friends/your_post_audiences.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={(): {'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, ('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',), 'dict': ('dict',), 'title': ('title',)}, ('media',): {'media': ()}, ('label_values', 'dict'): {'dict': ()}}),
    ],
    'Your Posts  Check Ins  Photos And Videos 1': [
        Entry(table='Your Posts  Check Ins  Photos And Videos 1', filename='personal_information/profile_information/your_facebook_activity/posts/your_posts__check_ins__photos_and_videos_1.json', static_fields={'timestamp': ('timestamp',), 'title': ('title',)}, list_blocks={(): {'timestamp': ('timestamp',), 'title': ('title',)}, ('data',): {'update_timestamp': ('update_timestamp',)}, ('attachments', 'data'): {'url': ('external_context', 'url')}}),
        Entry(table='Your Posts  Check Ins  Photos And Videos 1', filename='your_activity_across_facebook/posts/your_posts__check_ins__photos_and_videos_1.json', static_fields={'timestamp': ('timestamp',), 'title': ('title',)}, list_blocks={(): {'timestamp': ('timestamp',), 'title': ('title',)}, ('data',): {'post': ('post',)}, ('attachments', 'data'): {'url': ('external_context', 'url')}}),
        Entry(table='Your Posts  Check Ins  Photos And Videos 1', filename='your_facebook_activity/posts/your_posts__check_ins__photos_and_videos_1.json', static_fields={'timestamp': ('timestamp',), 'title': ('title',)}, list_blocks={(): {'timestamp': ('timestamp',), 'title': ('title',)}, ('data',): {'update_timestamp': ('update_timestamp',), 'post': ('post',), 'backdated_timestamp': ('backdated_timestamp',)}, ('attachments', 'data'): {'url': ('external_context', 'url'), 'name': ('external_context', 'name'), 'source': ('external_context', 'source'), 'title': ('life_event', 'title'), 'year': ('life_event', 'start_date', 'year'), 'month': ('life_event', 'start_date', 'month'), 'day': ('life_event', 'start_date', 'day')}}),
    ],
    'Your Preferred Categories': [
        Entry(table='Your Preferred Categories', filename='preferences/preferences/your_preferred_categories.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'ent_field_name': ('ent_field_name',), 'label': ('label',)}, ('label_values', 'vec'): {'ent_field_name': ('ent_field_name',)}, ('label_values', 'vec', 'dict'): {'ent_field_name': ('ent_field_name',), 'label': ('label',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Your Recent Reported Conversions': [
        Entry(table='Your Recent Reported Conversions', filename='ads_information/your_recent_reported_conversions.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={(): {'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, ('label_values',): {'label': ('label',), 'timestamp_value': ('timestamp_value',), 'ent_field_name': ('ent_field_name',)}, ('media',): {'media': ()}}),
    ],
    'Your Recently Followed History': [
        ...
        Entry(table='Your Recently Followed History', filename='your_facebook_activity/other_activity/your_recently_followed_history.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'ent_field_name': ('ent_field_name',)}, ('label_values', 'vec', 'dict'): {'label': ('label',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Your Saved Items': [
    ...
    'Your Video Consumption Summary': [
        ...
        Entry(table='Your Video Consumption Summary', filename='your_facebook_activity/other_activity/your_video_consumption_summary.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'ent_field_name': ('ent_field_name',), 'value': ('value',)}, ('media',): {'media': ()}}),
    ],
    'Your Videos': [
    ...
    'Your Watch Settings': [
        ...
        Entry(table='Your Watch Settings', filename='preferences/preferences/your_watch_settings.json', static_fields={'media': ('media',), 'fbid': ('fbid',), 'ent_name': ('ent_name',)}, list_blocks={('label_values',): {'label': ('label',), 'value': ('value',), 'ent_field_name': ('ent_field_name',), 'vec': ('vec',), 'timestamp_value': ('timestamp_value',)}, ('media',): {'media': ()}, ('label_values', 'vec'): {'vec': ()}}),
    ],
}

YT_ENTRIES: dict[str, list[Entry]] = {
    'Historial-De-BúSqueda': [
        Entry(table='Historial-De-BúSqueda', filename='historial/historial-de-búsqueda.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'description': ('description',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('details',): {'name': ('name',)}}),
    ],
    'Historial-De-Búsqueda': [
        Entry(table='Historial-De-Búsqueda', filename='historial/historial-de-búsqueda.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}}),
    ],
    ...
    'Istoricul CăUtăRilor': [
        Entry(table='Istoricul CăUtăRilor', filename='istoric/istoricul căutărilor.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'description': ('description',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('details',): {'name': ('name',)}}),
    ],
    'Istoricul Căutărilor': [
        Entry(table='Istoricul Căutărilor', filename='istoric/istoricul căutărilor.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}}),
    ],
    'Istoricul-VizionăRilor': [
        Entry(table='Istoricul-VizionăRilor', filename='istoric/istoricul-vizionărilor.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('subtitles',): {'name': ('name',), 'url': ('url',)}}),
    ],
    'Istoricul-Vizionărilor': [
        Entry(table='Istoricul-Vizionărilor', filename='istoric/istoricul-vizionărilor.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('subtitles',): {'name': ('name',), 'url': ('url',)}}),
    ],
    'Kijkgeschiedenis': [
    ...
    'PaiešKos Istorija': [
        Entry(table='PaiešKos Istorija', filename='istorija/paieškos istorija.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'description': ('description',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('details',): {'name': ('name',)}}),
    ],
    'Paieškos Istorija': [
        Entry(table='Paieškos Istorija', filename='istorija/paieškos istorija.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}}),
    ],
    'Search-History': [
    ...
    'ŽIūRėJimo Istorija': [
        Entry(table='ŽIūRėJimo Istorija', filename='istorija/žiūrėjimo istorija.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'description': ('description',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('details',): {'name': ('name',)}}),
    ],
    'Žiūrėjimo Istorija': [
        Entry(table='Žiūrėjimo Istorija', filename='istorija/žiūrėjimo istorija.json', static_fields={}, list_blocks={(): {'header': ('header',), 'title': ('title',), 'titleUrl': ('titleUrl',), 'time': ('time',), 'products': ('products',), 'activityControls': ('activityControls',)}, ('subtitles',): {'name': ('name',), 'url': ('url',)}}),
    ],
}

YT_CSV_ENTRIES: dict[str, list[Entry]] = {
    'Ajustes_de_moderación_de_la_comunidad_del_canal': [
        Entry(table='Ajustes_de_moderación_de_la_comunidad_del_canal', filename='Ajustes de moderación de la comunidad del canal.csv', static_fields={'ID de canal': ('ID de canal',)}, list_blocks={}),
    ],
    'Ajustes_de_moderación_de_la_comunidad_del_canal': [
        Entry(table='Ajustes_de_moderación_de_la_comunidad_del_canal', filename='Ajustes de moderación de la comunidad del canal.csv', static_fields={'ID de canal': ('ID de canal',)}, list_blocks={}),
    ],
    ...
    'Watch_later-videos': [
        Entry(table='Watch_later-videos', filename='Watch later-videos.csv', static_fields={'Video ID': ('Video ID',), 'Playlist Video Creation Timestamp': ('Playlist Video Creation Timestamp',), 'Vaizdo įrašo ID': ('Vaizdo įrašo ID',), 'Grojaraščio vaizdo įrašo sukūrimo laiko žymė': ('Grojaraščio vaizdo įrašo sukūrimo laiko žymė',)}, list_blocks={}),
    ],
    'Watch_later-vídeos': [
        Entry(table='Watch_later-vídeos', filename='Watch later-vídeos.csv', static_fields={'ID de vídeo': ('ID de vídeo',), 'Marca de tiempo de creación de la lista de reproducción de vídeos': ('Marca de tiempo de creación de la lista de reproducción de vídeos',)}, list_blocks={}),
    ],
    'abonamente': [
    ...
    'comentarios': [
        Entry(table='comentarios', filename='comentarios.csv', static_fields={'ID de comentario': ('ID de comentario',), 'ID de canal': ('ID de canal',), 'Marca de tiempo de creación del comentario': ('Marca de tiempo de creación del comentario',), 'Precio': ('Precio',), 'ID de vídeo': ('ID de vídeo',), 'Texto del comentario': ('Texto del comentario',)}, list_blocks={}),
    ],
    'comments': [
    ...
    'configuraciones_de_la_URL_del_canal': [
        Entry(table='configuraciones_de_la_URL_del_canal', filename='configuraciones de la URL del canal.csv', static_fields={'ID de canal': ('ID de canal',), 'Nombre de la URL mnemónica del canal (1)': ('Nombre de la URL mnemónica del canal (1)',), 'Nombre de la URL mnemónica del canal (2)': ('Nombre de la URL mnemónica del canal (2)',)}, list_blocks={}),
    ],
    'configuración_de_la_página_del_canal': [
        Entry(table='configuración_de_la_página_del_canal', filename='configuración de la página del canal.csv', static_fields={'ID de canal': ('ID de canal',)}, list_blocks={}),
    ],
    'configuración_de_la_página_del_canal': [
        Entry(table='configuración_de_la_página_del_canal', filename='configuración de la página del canal.csv', static_fields={'ID de canal': ('ID de canal',)}, list_blocks={}),
    ],
    ...
    'configurații_pentru_adresa_URL_a_canalului': [
        Entry(table='configurații_pentru_adresa_URL_a_canalului', filename='configurații pentru adresa URL a canalului.csv', static_fields={'ID-ul canalului': ('ID-ul canalului',), 'Numele adresei URL personalizate a canalului 1': ('Numele adresei URL personalizate a canalului 1',)}, list_blocks={}),
    ],
    ...
    'crochet-videos': [
        Entry(table='crochet-videos', filename='crochet-videos.csv', static_fields={'Video ID': ('Video ID',), 'Playlist Video Creation Timestamp': ('Playlist Video Creation Timestamp',), 'Vaizdo įrašo ID': ('Vaizdo įrašo ID',), 'Grojaraščio vaizdo įrašo sukūrimo laiko žymė': ('Grojaraščio vaizdo įrašo sukūrimo laiko žymė',)}, list_blocks={}),
    ],
    'crochet-vídeos': [
        Entry(table='crochet-vídeos', filename='crochet-vídeos.csv', static_fields={'ID de vídeo': ('ID de vídeo',), 'Marca de tiempo de creación de la lista de reproducción de vídeos': ('Marca de tiempo de creación de la lista de reproducción de vídeos',)}, list_blocks={}),
    ],
    'date_despre_funcțiile_canalului': [
        Entry(table='date_despre_funcțiile_canalului', filename='date despre funcțiile canalului.csv', static_fields={'ID-ul canalului': ('ID-ul canalului',), 'Moderare automată a canalului în chatul live': ('Moderare automată a canalului în chatul live',), 'Tipul prestabilit de comentarii permise ale videoclipului': ('Tipul prestabilit de comentarii permise ale videoclipului',), 'Publicul vizat prestabilit al videoclipului': ('Publicul vizat prestabilit al videoclipului',), 'Licența prestabilită a videoclipului': ('Licența prestabilită a videoclipului',)}, list_blocks={}),
    ],
    ...
    'kanalo_URL_konfigūracijos': [
        Entry(table='kanalo_URL_konfigūracijos', filename='kanalo URL konfigūracijos.csv', static_fields={'Kanalo ID': ('Kanalo ID',), '1 kanalo reklaminio URL pavadinimas': ('1 kanalo reklaminio URL pavadinimas',), '2 kanalo reklaminio URL pavadinimas': ('2 kanalo reklaminio URL pavadinimas',)}, list_blocks={}),
    ],
    'kanalo_URL_konfigūracijos': [
        Entry(table='kanalo_URL_konfigūracijos', filename='kanalo URL konfigūracijos.csv', static_fields={'Kanalo ID': ('Kanalo ID',), '1 kanalo reklaminio URL pavadinimas': ('1 kanalo reklaminio URL pavadinimas',)}, list_blocks={}),
    ],
    'kanalo_bendruomenės_moderavimo_nustatymai': [
        Entry(table='kanalo_bendruomenės_moderavimo_nustatymai', filename='kanalo bendruomenės moderavimo nustatymai.csv', static_fields={'Kanalo ID': ('Kanalo ID',)}, list_blocks={}),
    ],
    'kanalo_bendruomenės_moderavimo_nustatymai': [
        Entry(table='kanalo_bendruomenės_moderavimo_nustatymai', filename='kanalo bendruomenės moderavimo nustatymai.csv', static_fields={'Kanalo ID': ('Kanalo ID',)}, list_blocks={}),
    ],
    'kanalo_funkcijų_duomenys': [
        Entry(table='kanalo_funkcijų_duomenys', filename='kanalo funkcijų duomenys.csv', static_fields={'Kanalo ID': ('Kanalo ID',), 'Automatinis kanalo moderavimas tiesioginiame pokalbyje': ('Automatinis kanalo moderavimas tiesioginiame pokalbyje',), 'Numatytasis vaizdo įrašo leidžiamų komentarų tipas': ('Numatytasis vaizdo įrašo leidžiamų komentarų tipas',), 'Numatytoji vaizdo įrašo tikslinė auditorija': ('Numatytoji vaizdo įrašo tikslinė auditorija',), 'Numatytoji vaizdo įrašo licencija': ('Numatytoji vaizdo įrašo licencija',)}, list_blocks={}),
    ],
    ...
    'komentarai': [
        Entry(table='komentarai', filename='komentarai.csv', static_fields={'Komentaro ID': ('Komentaro ID',), 'Kanalo ID': ('Kanalo ID',), 'Komentaro sukūrimo laiko žymė': ('Komentaro sukūrimo laiko žymė',), 'Kaina': ('Kaina',), 'Vaizdo įrašo ID': ('Vaizdo įrašo ID',), 'Komentuoti tekstą': ('Komentuoti tekstą',)}, list_blocks={}),
    ],
    'playlists': [
    ...
    'setări_de_moderare_a_comunității_canalului': [
        Entry(table='setări_de_moderare_a_comunității_canalului', filename='setări de moderare a comunității canalului.csv', static_fields={'ID-ul canalului': ('ID-ul canalului',)}, list_blocks={}),
    ],
    'setările_paginii_de_canal': [
        Entry(table='setările_paginii_de_canal', filename='setările paginii de canal.csv', static_fields={'ID-ul canalului': ('ID-ul canalului',)}, list_blocks={}),
    ],
    'setări_de_moderare_a_comunității_canalului': [
        Entry(table='setări_de_moderare_a_comunității_canalului', filename='setări de moderare a comunității canalului.csv', static_fields={'ID-ul canalului': ('ID-ul canalului',)}, list_blocks={}),
    ],
    'setările_paginii_de_canal': [
        Entry(table='setările_paginii_de_canal', filename='setările paginii de canal.csv', static_fields={'ID-ul canalului': ('ID-ul canalului',)}, list_blocks={}),
    ],
    'subscriptions': [
    ...
    'vídeos': [
        Entry(table='vídeos', filename='vídeos.csv', static_fields={'ID de vídeo': ('ID de vídeo',), 'Duración aproximada (ms)': ('Duración aproximada (ms)',), 'Idioma del audio del vídeo': ('Idioma del audio del vídeo',), 'Categoría del vídeo': ('Categoría del vídeo',), 'Descripción del vídeo (original)': ('Descripción del vídeo (original)',), 'ID de canal': ('ID de canal',), 'Título del vídeo (original)': ('Título del vídeo (original)',), 'Privacidad': ('Privacidad',), 'Estado del vídeo': ('Estado del vídeo',), 'Marca de tiempo de creación del vídeo': ('Marca de tiempo de creación del vídeo',), 'Marca de tiempo de publicación del vídeo': ('Marca de tiempo de publicación del vídeo',)}, list_blocks={}),
    ],
}
