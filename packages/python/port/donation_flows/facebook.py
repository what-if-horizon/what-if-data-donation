...
def _0_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.name"], col_paths=dict())
...
def _6179754102079646_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.thread_name"], col_paths=dict())
...
def account_recoveries_without_password_changes_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.media"], col_paths=dict())
...
def admin_activity_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.timestamp"], col_paths=dict())
...
def ads_interests_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.topics_v2"], col_paths=dict())
...
def chat_invites_received_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.title"], col_paths=dict())
...
def stopwatch(message):
    ...
    try:
        ...
        print(f"[{time.time() - t:1.3f}] {message}")


def logins_and_logouts_df(file_input: list[str]) -> pd.DataFrame:
    with stopwatch("Read logins_and_logouts.json"):
        data = read_json(file_input, ["*/logins_and_logouts.json"])
    import json

    print(json.dumps(data, indent=2))
    with stopwatch("Extracted keys from json"):
        df = parse_json(
            data,
...
def your_badges_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(
        ...
        col_paths=dict(
            ...
            Doctorat___Metode_de_cercetare_cantitativa_2024_2025=[
                "Doctorat - Metode de cercetare cantitativa 2024-2025"
            ],
            ...
            Metode_de_cercetare_cantitative___Doctorat_2021_2022=[
                "Metode de cercetare cantitative - Doctorat 2021-2022"
            ],
            PhD_SNSPA=["PhD SNSPA"],
            ...
            FCRP_Metode_si_tehnici_de_elaborare_a_lucrarii_de_absolvire=[
                "FCRP_Metode si tehnici de elaborare a lucrarii de absolvire"
            ],
...
def your_locations_df(file_input: list[str]) -> pd.DataFrame:
    ...
    df = parse_json(data, row_path=["$.news_your_locations_v2"], col_paths=dict())
...
def create_donation_flow(file_input: list[str]):
    ...
    try:
        account_recoveries_without_password_changes_table = donation_table(
            ...
            title={
                "en": "account_recoveries_without_password_changes",
                "nl": "account_recoveries_without_password_changes",
            },
        )
    ...
    try:
        advertisers_using_your_activity_or_information_table = donation_table(
            ...
            title={
                "en": "advertisers_using_your_activity_or_information",
                "nl": "advertisers_using_your_activity_or_information",
            },
        )
    ...
    try:
        consent_for_combining_facebook_and_messenger_data_table = donation_table(
            ...
            title={
                "en": "consent_for_combining_facebook_and_messenger_data",
                "nl": "consent_for_combining_facebook_and_messenger_data",
            },
        )
    ...
    try:
        how_active_we_think_you_are_on_marketplace_table = donation_table(
            ...
            title={
                "en": "how_active_we_think_you_are_on_marketplace",
                "nl": "how_active_we_think_you_are_on_marketplace",
            },
        )
    ...
    try:
        information_you_ve_submitted_to_advertisers_table = donation_table(
            ...
            title={
                "en": "information_you_ve_submitted_to_advertisers",
                "nl": "information_you_ve_submitted_to_advertisers",
            },
        )
    ...
    try:
        messenger_active_status_platform_settings_table = donation_table(
            ...
            title={
                "en": "messenger_active_status_platform_settings",
                "nl": "messenger_active_status_platform_settings",
            },
        )
    ...
    try:
        messenger_threads_you_started_by_clicking_on_an_ad_table = donation_table(
            ...
            title={
                "en": "messenger_threads_you_started_by_clicking_on_an_ad",
                "nl": "messenger_threads_you_started_by_clicking_on_an_ad",
            },
        )
    ...
    try:
        notification_of_meta_privacy_policy_update_table = donation_table(
            ...
            title={
                "en": "notification_of_meta_privacy_policy_update",
                "nl": "notification_of_meta_privacy_policy_update",
            },
        )
    ...
    try:
        notifications_about_new_users_joining_facebook_table = donation_table(
            ...
            title={
                "en": "notifications_about_new_users_joining_facebook",
                "nl": "notifications_about_new_users_joining_facebook",
            },
        )
    ...
    try:
        your_actions_on_violating_content_in_your_groups_table = donation_table(
            ...
            title={
                "en": "your_actions_on_violating_content_in_your_groups",
                "nl": "your_actions_on_violating_content_in_your_groups",
            },
        )
    ...
    try:
        your_activity_off_meta_technologies_settings_table = donation_table(
            ...
            title={
                "en": "your_activity_off_meta_technologies_settings",
                "nl": "your_activity_off_meta_technologies_settings",
            },
        )
    ...
    try:
        your_content_visibility_notification_history_table = donation_table(
            ...
            title={
                "en": "your_content_visibility_notification_history",
                "nl": "your_content_visibility_notification_history",
            },
        )
    ...
    try:
        your_educational_notification_interactions_table = donation_table(
            ...
            title={
                "en": "your_educational_notification_interactions",
                "nl": "your_educational_notification_interactions",
            },
        )
    ...
    try:
        your_end_to_end_encryption_enabled_messenger_device_table = donation_table(
            ...
            title={
                "en": "your_end_to_end_encryption_enabled_messenger_device",
                "nl": "your_end_to_end_encryption_enabled_messenger_device",
            },
        )
    ...
    try:
        your_facebook_watch_activity_in_the_last_28_days_table = donation_table(
            ...
            title={
                "en": "your_facebook_watch_activity_in_the_last_28_days",
                "nl": "your_facebook_watch_activity_in_the_last_28_days",
            },
        )
    ...
    try:
        your_inferred_language_preferences_for_videos_table = donation_table(
            ...
            title={
                "en": "your_inferred_language_preferences_for_videos",
                "nl": "your_inferred_language_preferences_for_videos",
            },
        )
    ...
    try:
        your_instant_games_tournament_information_table = donation_table(
            ...
            title={
                "en": "your_instant_games_tournament_information",
                "nl": "your_instant_games_tournament_information",
            },
        )
    ...
    try:
        your_meta_business_suite_guidance_interactions_table = donation_table(
            ...
            title={
                "en": "your_meta_business_suite_guidance_interactions",
                "nl": "your_meta_business_suite_guidance_interactions",
            },
        )
    ...
    try:
        your_posts__check_ins__photos_and_videos_1_table = donation_table(
            ...
            title={
                "en": "your_posts__check_ins__photos_and_videos_1",
                "nl": "your_posts__check_ins__photos_and_videos_1",
            },
        )
    ...
    print(f"Total time for creating tables: {time.time() - start_time:1.2f}")
...
if __name__ == "__main__":
    ...
    with stopwatch("Total time to create dfs"):
        d = profile_information_df([sys.argv[1]])
        d = autofill_information_df([sys.argv[1]])
        d = logins_and_logouts_df([sys.argv[1]])
        print(d)
