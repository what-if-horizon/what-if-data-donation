...
merged_df.to_csv(f"{final_directory}/FB_Merged_structures.csv", index=False)

time = datetime.datetime.now()
print(f'{time}: FB_Merged_structures.csv saved')

time = datetime.datetime.now()
print(f'{time}: FINISHED PROCESSING FACEBOOK')
