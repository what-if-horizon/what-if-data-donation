...
export function isResponse(arg: any): arg is Response {
  return (
    isInstanceOf<Response>(arg, "Response", ["command", "payload"]) &&
...
export function isCommandSystemExit(arg: any): arg is CommandSystemExit {
  return isInstanceOf<CommandSystemExit>(arg, "CommandSystemExit", [
    "code",
    "info",
  ]);
}
...
export function isCommandSystemDonate(arg: any): arg is CommandSystemDonate {
  return isInstanceOf<CommandSystemDonate>(arg, "CommandSystemDonate", [
    "key",
    "json_string",
  ]);
}
...
export function isCommandUIRender(arg: any): arg is CommandUIRender {
  return (
    isInstanceOf<CommandUIRender>(arg, "CommandUIRender", ["page"]) &&
    isPropsUIPage(arg.page)
  );
}
