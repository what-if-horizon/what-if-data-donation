...
export function isPropsUIPromptConfirm(arg: any): arg is PropsUIPromptConfirm {
  return isInstanceOf<PropsUIPromptConfirm>(arg, "PropsUIPromptConfirm", [
    "text",
    "ok",
    "cancel",
  ]);
...
export function isPropsUIPromptFileInputMultiple(
  arg: any,
): arg is PropsUIPromptFileInputMultiple {
  return isInstanceOf<PropsUIPromptFileInputMultiple>(
    arg,
...
export function isPropsUIPromptProgress(
  arg: any,
): arg is PropsUIPromptProgress {
  return isInstanceOf<PropsUIPromptProgress>(arg, "PropsUIPromptProgress", [
    "description",
    "message",
  ]);
}
...
export function isPropsUIPromptRadioInput(
  arg: any,
): arg is PropsUIPromptRadioInput {
...
export function isPropsUIPromptConsentForm(
  arg: any,
): arg is PropsUIPromptConsentForm {
  return isInstanceOf<PropsUIPromptConsentForm>(
    arg,
    "PropsUIPromptConsentForm",
    ["id", "tables", "metaTables"],
  );
}
...
export function isPropsUIPromptConsentFormTable(
  arg: any,
): arg is PropsUIPromptConsentFormTable {
  return isInstanceOf<PropsUIPromptConsentFormTable>(
    arg,
    "PropsUIPromptConsentFormTable",
    ["id", "title", "description", "data_frame"],
  );
}
...
export function isPropsUIPromptQuestionnaire(
  arg: any,
): arg is PropsUIPromptQuestionnaire {
  return isInstanceOf<PropsUIPromptQuestionnaire>(
    arg,
